    ...
    <header id="main-header" className="h-16 border-b border-white/5 bg-[#0f172a]/80 backdrop-blur-md px-6 flex items-center justify-between sticky top-0 z-30">
      ...
      <div className="flex items-center gap-4 flex-1 max-w-md">
        <button
          ...
          className="w-full flex items-center justify-between px-3.5 py-2 rounded-xl bg-white/[0.04] hover:bg-white/[0.07] border border-white/10 text-slate-400 text-sm transition-all text-left group cursor-pointer"
        >
      ...
      <div className="flex items-center gap-3.5">
        ...
        {roleType === 'admin' && (
          <button
            ...
            className="hidden sm:flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold bg-white/[0.05] hover:bg-white/[0.09] text-slate-200 border border-white/10 transition-all hover:border-purple-500/40 cursor-pointer"
          >
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-3 p-1.5 pl-2 rounded-xl hover:bg-white/[0.05] border border-transparent hover:border-white/10 transition-all cursor-pointer"
          >
            <div className="relative">
              <img
